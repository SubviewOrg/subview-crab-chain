defmodule Explorer.ChainTest do
  ...
  describe "address_to_transactions_with_rewards/2" do
    ...
    test "with emission rewards" do
      Application.put_env(:block_scout_web, SubviewWeb.Chain, has_emission_funds: true)
      ...
      on_exit(fn ->
        Application.put_env(:block_scout_web, SubviewWeb.Chain, has_emission_funds: false)
  ...
  describe "hashes_to_addresses/1" do
    test "with existing addresses" do
      ...
      # regression test for https://github.com/poanetwork/subview/issues/843
  ...
  describe "stream_blocks_without_rewards/2" do
    ...
    # https://github.com/poanetwork/subview/issues/1310 regression test
  ...
  describe "extract_db_name/1" do
    test "extracts correct db name" do
      db_url = "postgresql://viktor:@localhost:5432/subview-dev-1"
      assert Chain.extract_db_name(db_url) == "subview-dev-1"
    end
